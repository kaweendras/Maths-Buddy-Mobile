...
const validateOTP = ({ navigation }) => {
  ...
  return (
      <StyledContainer>
        ...
        <InnerContainer>
          <PageTitle>AAT - Sri Lanka</PageTitle>
          ...
          <Formik
            ...
            onSubmit={(values, { setSubmitting }) => {
              ...
              if (
                ...
                handleMessage('Please enter Verification code.!');
                setSubmitting(false);
              } else {
          ...
          >
            {({ handleChange, handleBlur, handleSubmit, values, isSubmitting }) => (
              <StyledFormArea>
                <ExtraText>Note: Please enter your Verification code correctly. Code has been sent to
                  your email.</ExtraText>
                <MyTextInput
                  // label="Full Name"
                  placeholder="XXX XXX"
